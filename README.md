...
Project scaffold for pollapp-node
...
Then, the the generated code will be executed as *`node dist/pollapp-node.js`*.  
...
To execute the code, run *`node dist/pollapp-node.js`*.  
*Note:* Entry point for project is set to index.ts.
